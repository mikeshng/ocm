...
require (
	...
	open-cluster-management.io/addon-framework v1.3.1-0.20260902141743-f80fc02deef8
...
replace open-cluster-management.io/api => github.com/kahirokunn/api v1.3.1-0.20260904090248-87af7d144912
